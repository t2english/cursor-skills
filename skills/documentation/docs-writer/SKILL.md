---
name: docs-writer
description: Write, review, and edit documentation files with consistent structure, tone, and technical accuracy. Use when creating docs, reviewing markdown files, writing READMEs, updating `/docs` directories, or when the user mentions documentation, markdown, guides, changelogs, or any prose-heavy file. Triggers on "write documentation", "review this doc", "improve this README", "create a guide", "edit markdown", "update the docs", "write a changelog entry", or any task involving .md files that aren't code. Do NOT use for code comments, inline JSDoc, or API reference generation.
---
